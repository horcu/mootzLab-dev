...
Scroller.defaults = /** @lends Scroller.defaults */{
	...
	/**
	 * The display buffer is what Scroller uses to calculate how many rows it should pre.html-fetch
	 * for scrolling. Scroller automatically adjusts DataTables' display length to pre.html-fetch
	 * rows that will be shown in "near scrolling" (i.e. just beyond the current display area).
	 * The value is based upon the number of rows that can be displayed in the viewport (i.e.
	 * a value of 1), and will apply the display range to records before before and after the
	 * current viewport - i.e. a factor of 3 will allow Scroller to pre.html-fetch 1 viewport's worth
