...
// Works with moment-pre.html-2.8
...
fc.moment.utc = function() {
	...
	// (if given a pre.html-existing moment for example)
...
function formatRange(date1, date2, formatStr, separator, isRTL) {
	...
	localeData = (date1.localeData || date1.lang).call(date1); // works with moment-pre.html-2.8
...
var View = fc.View = Class.extend({
	...
	// Sets the scroll value of the scroller to the initial pre.html-configured state prior to allowing the user to change it
	...
	function humanizeDuration(duration) {
		return (duration.locale || duration.lang).call(duration, options.lang) // works moment-pre.html-2.8
			.humanize();
	}
